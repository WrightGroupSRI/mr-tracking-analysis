...
for idx,row in enumerate(to_plot_df.itertuples()):
    test = displacement_box_plot('Subject '+str(row.Subject), 'Recording ' + str(row.Recording), row.displacements, axis=ax_list[idx])
...
for idx,row in enumerate(to_plot_df.itertuples()):
    ...
    test = delta_plot_refactor('Subject '+str(row.Subject), 'Recording ' + str(row.Recording), delta_arrs, algos=sel_algos,                        axis=ax_list[idx])
    stat_tests.append(test)
...
for idx,row in enumerate(to_plot_df.itertuples()):
    test = orientation_box_plot('Subject '+str(row.Subject), 'Recording ' + str(row.Recording), row.orientation_deltas, axis=ax_list[idx])
    stat_tests.append(test)
...
for idx,row in enumerate(to_plot_df.itertuples()):
    test = tip_tilt_box_plot('Subject '+str(row.Subject), 'Recording ' + str(row.Recording), row.tip_angles_from_mean, axis=ax_list[idx])
    stat_tests.append(test)
